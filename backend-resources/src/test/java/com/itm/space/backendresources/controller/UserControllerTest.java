...
@WithMockUser(username = "waterfall", password = "roma", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        userRequest = new UserRequest("waterfall", "molniya@rumbler.com", "roma", "Roman", "Waterfall");
    }
    ...
    void testHello() {
        try {
            ...
            assertEquals("waterfall", responseContent);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    void getUserById() {
        try {
            ...
            assertEquals("privet", userResponse.getFirstName());
